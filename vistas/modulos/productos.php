  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <div class="box-body">
       ...
       <table id="example"class="table table-bordered table-striped dt-responsive tablaProductos" width="100%">
    ...
    <div class="modal-content">
      ...
      <form role="form" method="post" enctype="multipart/form-data">
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" name="nuevoCodigo" placeholder=" código" id="nuevoCodigo" required>
        ...
        <div class="modal-footer">
          ...
          <button type="submit" class="btn btn-purple">Guardar producto</button>
